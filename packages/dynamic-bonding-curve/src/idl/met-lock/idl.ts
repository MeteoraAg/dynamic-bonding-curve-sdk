...
export type Locker = {
    ...
    instructions: [
      {
        ...
        accounts: [
          ...
          {
            name: "rentReceiver";
            docs: ["CHECKED: The Token Account will receive the rent"];
            writable: true;
          },
          {
            name: "signer";
          ...
          },
          {
            ...
            pda: {
              seeds: [
                {
                  kind: "const";
                  value: [114, 111, 111, 116, 95, 101, 115, 99, 114, 111, 119];
                },
                {
                  kind: "account";
                  path: "base";
      ...
      },
      {
        ...
        discriminator: [23, 100, 197, 94, 222, 153, 38, 90];
        accounts: [
          {
            name: "base";
            docs: ["Base."];
      ...
      },
      {
        ...
        docs: ["Crate vesting escrow from root"];
    ...
    accounts: [
      {
        name: "rootEscrow";
        discriminator: [253, 209, 220, 107, 206, 191, 71, 158];
      },
      {
        name: "vestingEscrow";
        discriminator: [244, 119, 183, 4, 73, 116, 135, 195];
      },
      {
        name: "vestingEscrowMetadata";
        discriminator: [24, 204, 166, 104, 87, 158, 76, 13];
      }
    ];
    events: [
      {
        name: "eventCancelVestingEscrow";
        discriminator: [113, 2, 117, 173, 195, 39, 101, 155];
      },
      {
        name: "eventCancelVestingEscrowV3";
        discriminator: [41, 143, 236, 79, 116, 120, 91, 143];
      },
      {
        name: "eventClaim";
        discriminator: [171, 144, 1, 189, 120, 200, 38, 11];
      },
      {
        name: "eventClaimV3";
        discriminator: [229, 197, 142, 10, 41, 122, 171, 154];
      },
      {
        name: "eventCloseClaimStatus";
        discriminator: [87, 68, 38, 194, 241, 155, 125, 107];
      },
      {
        name: "eventCloseVestingEscrow";
        discriminator: [45, 141, 253, 209, 196, 133, 21, 204];
      },
      {
        name: "eventCreateRootEscrow";
        discriminator: [105, 216, 97, 182, 27, 224, 199, 228];
      },
      {
        name: "eventCreateVestingEscrow";
        discriminator: [248, 222, 89, 61, 170, 208, 131, 117];
      },
      {
        name: "eventFundRootEscrow";
        discriminator: [74, 8, 68, 181, 198, 235, 138, 81];
      },
      {
        name: "eventUpdateVestingEscrowRecipient";
        discriminator: [206, 218, 33, 65, 133, 237, 131, 57];
      }
    ];
    errors: [
      {
        ...
        type: {
          ...
          fields: [
            ...
            },
            {
              ...
              docs: ["total escrow created"];
              type: "u64";
            },
            {
              name: "totalDistributeAmount";
              docs: ["total distributed amount"];
              type: "u64";
            },
            {
              name: "version";
